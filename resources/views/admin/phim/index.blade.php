      ...
      <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header">
              <button data-toggle="modal" data-target="#modal_createtheloai" class="btn btn-primary"><span class="fa fa-plus"></span> Thêm</button>
              ...
              <table id="data_table" class="table table-bordered table-striped table-responsive table-condensed">
                ...
                @foreach($phim as $p)
	                <tr>
	                  ...
	                  <td>{{$p->NgayKetThuc}}</td>
	                  <td>{{$p->theloai()->first()->TenTheLoai}}</td>
	                  <td>{{$p->created_at}}</td>
	                  <td>{{$p->updated_at}}</td>
	                  <td>
	                  	...
	                  	<button class="btn btn-primary" data-toggle="modal" data-target="#modal_updateslide" data-id="{{$p->id}}">
	                  		<span class="fa fa-edit"></span>
	                  	</button>
	                  	<button class="btn btn-danger btn_xoa" data-id="{{$p->id}}" data-toggle="modal" data-target="#modal_delete">
...
$(document).ready(function() {
	$('.btn_xoa').click(function(event) {
        ...
        $('#modal_delete form').attr('action','admin/phim/'+id)
	});
});
</script>
@endpush
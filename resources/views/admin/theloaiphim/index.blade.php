              ...
              <table id="data_table" class="table table-bordered table-striped table-responsive table-condensed">
                ...
                @foreach($theloai as $tl)
	                <tr>
	                  ...
	                  <td>{{$tl->updated_at}}</td>
	                  <td>
	                  	<button class="btn btn-primary" data-toggle="modal" data-target="#modal_updateslide" data-id="{{$tl->id}}">
	                  		<span class="fa fa-edit"></span>
	                  	</button>
	                  	<button class="btn btn-danger btn_xoa" data-id="{{$tl->id}}" data-toggle="modal" data-target="#modal_delete">

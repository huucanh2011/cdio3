...
<div class="container-fulid" style="padding: 0rem 2.5rem">
        <div class="padding">
            <ul class="nav nav-tabs text-uppercase">
                <li><a data-toggle="tab" href="#phimDangChieu">Phim đang chiếu</a></li>
                <li class="active"><a data-toggle="tab" href="#phimSapChieu">Phim sắp chiếu</a></li>
            </ul>
        </div>
        <div class="tab-content">
            <div class="tab-pane fade" id="phimDangChieu">
            ...
            <div class="tab-pane fade in active" id="phimSapChieu">
                <div class="row text-center">
